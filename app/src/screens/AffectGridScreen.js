          ...
          >
            <defs>
              <radialGradient id="fog" cx="50%" cy="50%" r="50%">
                <stop offset="0%" stopColor="#FFD3AC" stopOpacity="0.55" />
                <stop offset="100%" stopColor="#f0a888" stopOpacity="0.85" />
              </radialGradient>
              {/* Quadrant fills */}
              <linearGradient id="q-tl" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#9988A1" stopOpacity="0.18" />
                <stop offset="100%" stopColor="transparent" />
              </linearGradient>
              <linearGradient id="q-tr" x1="100%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="#E35336" stopOpacity="0.18" />
                <stop offset="100%" stopColor="transparent" />
              </linearGradient>
              <linearGradient id="q-bl" x1="0%" y1="100%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#8A2B0E" stopOpacity="0.15" />
                <stop offset="100%" stopColor="transparent" />
              </linearGradient>
              <linearGradient id="q-br" x1="100%" y1="100%" x2="0%" y2="0%">
                <stop offset="0%" stopColor="#9988A1" stopOpacity="0.12" />
                <stop offset="100%" stopColor="transparent" />
              </linearGradient>
            </defs>
            ...
            {/* Cross hair */}
            <line x1={RADIUS} y1={10} x2={RADIUS} y2={SIZE-10} stroke="rgba(138,43,14,0.2)" strokeWidth="1" strokeDasharray="4,4" />
            <line x1={10} y1={RADIUS} x2={SIZE-10} y2={RADIUS} stroke="rgba(138,43,14,0.2)" strokeWidth="1" strokeDasharray="4,4" />
